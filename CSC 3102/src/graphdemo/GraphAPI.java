...
/** 
 * Describes a methods for a class that implements a weighted digraph
 * @param <E> the data type of the graph; E must implement the standard
 * Java parametric Comparable interface.
